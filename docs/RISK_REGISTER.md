...
- **2026-09-02 — Phase 1 exit / 01-09 Task 3.** R-13 closed on CI evidence (Windows `GNU Make
  4.4.1` / `x86_64-w64-mingw32`, run 33623157930). 13 risks recorded; 12 open, 1 closed.
- **2026-09-02 — Plan 03-09 Task 2.** R-14 added: `exports/mmm_input_weekly.csv`
