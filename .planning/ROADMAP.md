...
- [ ] **Phase 2: Ground-Truth Simulator** - Three scenario datasets with disclosed truth files, deterministic to the byte (P1 / M1) — 02-01…02-05 complete on this lineage
...
| 2. Ground-Truth Simulator | M1 | 5/10 | In Progress | - |
