...
- [x] 04-03-PLAN.md — T-302 MD-070 shared-shape transform sanity (wave 3)

**Wave 4** *(blocked on Waves 1–2)*

- [x] 04-04-PLAN.md — T-304 `build_model` + `sample_model` + CI smoke fit (wave 4)

**Wave 5** *(blocked on Wave 4)*

- [x] 04-05-PLAN.md — T-305 posterior_io (wave 5)
...
- [x] 04-07-PLAN.md — T-307 `make fit-synthetic` (P-SA) + committed posterior + MD-071/072 (wave 7)
