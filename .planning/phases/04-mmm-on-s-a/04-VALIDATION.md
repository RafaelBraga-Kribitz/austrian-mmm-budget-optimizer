...
| MD-073 ladder, if needed | MD-071 | Only if the full fit is unhealthy | Follow rungs in order; ADR-005 past rung 1 | ✅ triggered; 0 divergences at `target_accept` 0.99 (ADR-011) |
